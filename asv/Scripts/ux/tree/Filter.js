Ext.define('Ext.ux.tree.Filter', {
    ...
    filter: function (value, props, re) {
        var me = this,
            tree = me.tree,
            matches = [],                                                  // array of nodes matching the search criteria
            root = tree.getRootNode(),                                     // root node of the tree
            props = props || 'text',                                       // property is optional - will be set to the 'text' propert of the  treeStore record by default
